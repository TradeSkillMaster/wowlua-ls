...
impl AnalysisResult {
    ...
    pub fn collect_name_tokens_recursive<'b>(node: SyntaxNode<'b>) -> Vec<SyntaxToken<'b>> {
    ...
    pub fn is_table_subtype(&self, actual: &ValueType, expected: &ValueType) -> bool {
    ...
    pub fn structural_mismatch_details(&self, actual: &ValueType, expected: &ValueType) -> Option<Vec<super::StructuralMismatchDetail>> {
        super::structural_mismatch_details_impl(&self.ir, &self.resolved_expr_cache, actual, expected)
    }

    pub fn check_excess_structural_fields(
        &self,
    ...
    pub(crate) fn collect_class_fields(&self, table_idx: TableIndex) -> Vec<(String, ValueType, bool)> {
    ...
    pub fn is_function_compatible(&self, actual: &ValueType, expected: &ValueType) -> bool {
    ...
    pub fn find_enclosing_function_idx(
        &self,
        node: SyntaxNode<'_>,
    ...
    pub fn find_enclosing_function_generics(
        &self,
        node: SyntaxNode<'_>,
        func_by_start: &HashMap<u32, FunctionIndex>,
    ...
    pub fn get_check_time_type_args(&self, expr_id: ExprId) -> Vec<ValueType> {
    ...
    pub fn class_has_field(&self, table_idx: TableIndex, field_name: &str) -> bool {
        super::class_has_field_impl(&self.ir, table_idx, field_name)
    }

    pub fn block_ends_with_return(block: &Block) -> bool {
        Self::block_always_exits(block)
    }

    pub fn block_always_exits(block: &Block) -> bool {
    ...
    pub fn is_infinite_loop_stmt(stmt: &Statement) -> bool {
        match stmt {
            Statement::While(wl) => {
...
pub fn is_local_definition(root: &SyntaxNode, def_start: u32) -> bool {
...
pub fn extract_bracket_string_key(field_node: &SyntaxNode) -> Option<String> {
