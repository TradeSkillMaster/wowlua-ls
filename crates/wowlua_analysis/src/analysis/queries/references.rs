...
impl AnalysisResult {
    ...
    pub fn def_name_token_range(&self, tree: &SyntaxTree, def_start: u32, def_end: u32, name: &str) -> Option<TextRange> {
    ...
    pub fn is_local_declaration_site(&self, tree: &SyntaxTree, def_start: u32) -> bool {
    ...
    pub fn find_param_in_annotation_at(
        &self,
        tree: &SyntaxTree,
        offset: u32,
