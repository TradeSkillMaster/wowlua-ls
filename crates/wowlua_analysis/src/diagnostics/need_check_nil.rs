...
pub fn run_callee(analysis: &AnalysisResult, diags: &mut Vec<WowDiagnostic>) {
...
pub fn check_index(diags: &mut Vec<WowDiagnostic>, type_str: &str, start: usize, end: usize) {
    super::NEED_CHECK_NIL.emit(diags, format!("index access on possibly-nil value of type '{}'", type_str), start, end);
}

pub fn check_call(diags: &mut Vec<WowDiagnostic>, type_str: &str, start: usize, end: usize) {
