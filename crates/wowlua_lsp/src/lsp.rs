...
pub use main_loop::WorkspaceScanResult;
pub use main_loop::load_precomputed_stubs;
pub use main_loop::stub_materialize_dir;
...
pub use main_loop::ConfigEditContext;
...
impl<'a> SafeLinePositions<'a> {
    ...
    pub fn line_col(&self, offset: usize) -> (line_numbers::LineNumber, usize) {
        if offset > self.len {
    ...
    pub fn lsp_position(&self, offset: usize, utf8: bool) -> lsp_types::Position {
    ...
    pub fn lsp_range(&self, start: usize, end: usize, utf8: bool) -> lsp_types::Range {
        lsp_types::Range {
    ...
    pub fn lsp_length(&self, start: usize, byte_len: u32, utf8: bool) -> u32 {
        if utf8 {
            byte_len
        } else {
...
pub fn lsp_position_to_offset(text: &str, line: u32, character: u32, utf8: bool) -> u32 {
    let mut offset = 0u32;
