...
3. Run `code --extensionDevelopmentPath=<absolute_path_to_editors/vscode> --disable-extensions <project_path>`. Do NOT background the process with `&` — it doesn't work. Just run it directly; `code` returns immediately on its own.
