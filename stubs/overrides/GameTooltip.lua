...
---@overload fun(self: GameTooltip, atlas: string, minx: number, maxx: number, miny: number, maxy: number)
...
---@param owner any -- intentionally untyped: Frame or WORLDFRAME; annotating as Frame causes false positives when addon mixins pass self
