...
features:
  ...
  - title: WoW API out of the box
    details: Ships with complete retail + classic API stubs from Ketho's vscode-wow-api. Hover any WoW function for its signature. Configure target flavors to catch API mismatches.
